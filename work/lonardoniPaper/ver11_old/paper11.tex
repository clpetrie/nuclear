...
constructed in order to have a good trial wave function with the proper $(J^\pi,T)$.
...
wave function is already 119, making computationally challenging to include $sd$ shell orbitals for $A=12$.
