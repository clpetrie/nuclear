...
\right| . 
\end{align}
For \isotope[16]{O}, for instance, the number of states is four: 
...
(\isotope[6]{He}), or in 32 Slater determinants to have a $J=1,T=0$
wave function (\isotope[6]{Li}). Finally, for \isotope[12]{C}, by 
considering only $K=4$ as for \isotope[16]{O}, the number of Slater
...
\begin{table*}[htb]
\centering
\caption[]{Expectation value of the energy contributions in \isotope[6]{Li} and \isotope[16]{O}.
