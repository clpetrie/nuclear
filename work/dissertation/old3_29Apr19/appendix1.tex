...
The $A^{\sigma\tau}$ matrix can be written in terms of it's square root matrix, which as shown before, can be written in terms of it's eigenvalues and vectors as
\begin{align}
