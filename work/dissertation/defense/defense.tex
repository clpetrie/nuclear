...
\begin{frame}{VMC - Parameter Variation}
   ...
   \red{\\ See thesis from Casula, New QMC approaches for the simulation of electronic systems: a first application to aromatic molecules and transition metal compounds.}
\end{frame}
