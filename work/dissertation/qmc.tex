...
\blue{START HERE TOMORROW!!!!!!!}
This potential can be written in the more convenient form
\begin{equation}
...
\red{\\Include bit about 4 different weights from Lonardoni2018 paper, page 7.}
