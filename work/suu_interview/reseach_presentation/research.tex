...
\begin{frame}{DELETE THIS OUTLINE}
\begin{itemize}
   \item Explain what kind of problem you are trying to solve
   \begin{itemize}
      \item Mix in a brief introduction to Quantum Mechanics
   \end{itemize}
   \item Explain how the problem is solved.
   \item Explain what you have done {\bf and} what students could do with you in the future.
\end{itemize}
\end{frame}
...
\begin{frame}{DELETE THIS OUTLINE TOO}
\begin{itemize}
   \item \red{Fix frame total slide numbering in footer, it's right in pdinterview.pdf}
   \item Start with a brief description of the atom, as described by Rutherford.
   \item Compare EM force to nuclear force and show some of the crude models, explaining why we have the crude models. Mention that it actually depends on other QM properties like spin, etc.
      \begin{itemize}
         \item Talk about e- orbitals and how QM was able to describe the periodic table maybe.
      \end{itemize}
   \item Brief explanation of how QM works and a wave function
   \item Schr\"odinger equation is the way to solve nuclear physics problems.
   \item Show the integral that you're solving.
   \item How QMC work to solve these kinds of problems.
   \item What you've done.
   \item What you think would be good to do in the future WITH SUU STUDENTS. Including non-nuclear computational projects (mention flexibility).
   \item Mention of possible collaborations.
\end{itemize}
\end{frame}

\section{Nuclear Physics}
\begin{frame}{Nuclear Physics Problem}
\begin{itemize}
   \item We all have this picture in our head of an atom: dense nucleus in the center that we mostly ignore except for it's protons charges and a bunch of electrons zipping around around it.
   \item<2> We know how the calculate interactions between the electrons, and between the electrons and protons.
   \item<3> What about the nucleons (neutrons and protons), how do they interact with eachother and with electrons?
   \begin{center}
      \includegraphics[width=0.7\textwidth]{figures/atom.jpg}
   \end{center}
\end{itemize}
\end{frame}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.7\textwidth]{figures/mr.png}
\end{figure}
\vspace{-0.5cm}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.70\textwidth]{figures/gpp.png}
\end{figure}
\end{frame}
