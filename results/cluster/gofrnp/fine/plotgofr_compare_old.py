...
#Get every other data point for continuum data [start:stop:step]
print data[0][0][0]
data[0][:][0]=(data[0][:][0])[0::5]
data[0][:][sys]=(data[0][:][sys])[0::5]
print " "
print " "
print data[0][0][0]
#print temp1
...
for n in range(0,lenfiles):
   plt.errorbar(data[:,0],data[:,sys],yerr=data[n][:][sys+1],fmt=pltstyle[n],label=titles[n])
